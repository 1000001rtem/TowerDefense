...
public class GameScreen implements Screen {
    ...
    private Group groupSaveAndLoadGame;
    ...
    public GameScreen(SpriteBatch batch, Camera camera, MenuScreen menu) {
        this.batch = batch;
        this.camera = camera;
        this.menu = menu;
    }
    ...
    public void createGUI() {
        ...
        groupTurretAction.setPosition(50, 560);
        ...
        groupTurretSelection.setPosition(50, 460);
        ...
        groupSaveAndLoadGame = new Group();
        groupSaveAndLoadGame.setPosition(50, 50);

        Button btnSaveGame = new TextButton("Save", skin, "simpleSkin");
        Button btnExit = new TextButton("Exit", skin, "simpleSkin");
        btnSaveGame.setPosition(10, 30);
        btnExit.setPosition(110, 30);
        groupSaveAndLoadGame.addActor(btnSaveGame);
        groupSaveAndLoadGame.addActor(btnExit);
        ...
        stage.addActor(groupSaveAndLoadGame);
